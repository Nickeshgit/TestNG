...
public class Parallel_FindElements {
	 ...
	 * Base_Class.browser_Launch("chrome");
	 * Base_Class.getURL("https://letcode.in/edit"); List<WebElement> labels =
	 * driver.findElements(By.tagName("label")); WebElement last =
	 * labels.get(labels.size() - 1); System.out.println(last.getText()); int size =
	 * labels.size(); if (size == 6) { System.out.println("Passed"); for (WebElement
	 * lb : labels) { System.out.println(lb.getText()); } }
	 * 
